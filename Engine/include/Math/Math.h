...
struct Vec2
{
    ...
    //------------------------------------------------------------------------------
    explicit constexpr Vec2(const float* vec)
        : x(vec[0]), y(vec[1])
    {
    }
...
struct Vec3
{
    ...
    //------------------------------------------------------------------------------
    explicit constexpr Vec3(Vec4 vec)
    ...
    {
        return Abs(1.0f - LengthSqr()) < 0.0001f;
    }
...
//------------------------------------------------------------------------------
inline constexpr Vec4::Vec4(const Vec3& v, float w)
